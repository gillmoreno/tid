...
- Write a **take** (2–3 sentences: what was said, why it matters, Gil's skeptical-curious angle)
- Write **post_text** ready to paste on X (hook, blank line, take, blank line, `Source: {Podcast}`, blank line, `{YouTube URL}`)
